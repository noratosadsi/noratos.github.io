...
<td>&nbsp;&nbsp;<input disabled type="datetime" value="<?php echo $horaingreso;?>">&nbsp;&nbsp;</td>
...
<td>&nbsp;&nbsp;<input type="text" value="<?php echo $tiempo; ?>"disabled>&nbsp;&nbsp;</td>
</tr>
...
<td>Minutos</td>
<td><input type="radio" id="r1" onclick="myFunction()" name="tarifa" value="minutos"></td><!--checked="checked"-->
<td></td>
<td>Capacidad</td>
...
<td><input type="text" name="costotarif" value="" style="text-align:center;background-color: #E9E9E9" readonly></td>
...
<tr>
<td>Horas</td>
<td><input type="radio" id="r2" onclick="myFunction()" name="tarifa" value="horas"></td>
<td></td>
<td>Ocupados</td>
...
<tr>
<td>Dias</td>
<td><input type="radio" id="r3" onclick="myFunction()" name="tarifa" value="dias"></td>
<td></td>
<td>Disponible</td>
...
<td>Efectivo</td>
<td><input type="text" name="efectivo" style="text-align:center;background-color: #E9E9E9" readonly></td>
</tr>
</tr>

<tr>
<td>Mensualidad</td>
<td><input type="radio" id="r4" onclick="myFunction()" name="tarifa" value="mes"></td>
<td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
<td colspan="3"></td>
<td>Cambio</td>
